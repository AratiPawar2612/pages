          ...
          <Layout style={{ height: "51.5rem", width: "100%" }}>
            ...
            <div className="logo">
              ...
              <div className="nav" style={{display:"flex",justifyContent:"space-evenly"}}>
                ...
                <div>Login</div>
                <div>
                    <Button style={{backgroundColor:"orange",borderRadius:"3rem"}}>Sign up</Button>
                </div>
                </div>
            ...
            >
              <p>
                Scroll New book in evl now! <a href="./">Order now</a>
              </p>
            </Footer>
            <Content>
                <img style={{height:"42.3rem",width:"100%",position:"absolute"}} src="https://images5.alphacoders.com/134/1346500.png"/>
                <div style={{position:"relative", height:"20rem",width:"30rem",textAlign:"center",paddingTop:"10rem",marginLeft:"3rem"}}>
                    <h1>EPS VECTORS</h1>
                    <h2>Background</h2>
                    ...
                    <Button style={{background:"orange"}}>GET`S STARTED</Button>          
                </div>
            </Content>
          </Layout>
        </Flex>
